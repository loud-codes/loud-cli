...
[![Version](https://img.shields.io/badge/version-1.8.0-a2cd65?style=flat-square)](#)
...
Since **LOUD 2.0** (May 2026) the server runs on an LOUD's dedicated GPU cloud,
...
- [x] **LOUD 2.0 — GPU backend with dedicated GPU cloud**  *(May 2026)*
- [x] **`loud-2.0` model (flagship) usable in production**
